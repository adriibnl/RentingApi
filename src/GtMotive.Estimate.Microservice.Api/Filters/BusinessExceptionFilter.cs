...
namespace GtMotive.Estimate.Microservice.Api.Filters
{
    public sealed class BusinessExceptionFilter(IAppLogger<BusinessExceptionFilter> appLogger) : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            _appLogger.LogError("Exception captured in BusinessExceptionFilter: {message}", context.Exception.Message);
            ...
            else
            {
                ...
                _appLogger.LogError("Unhandled Exception: {message}", context.Exception.Message);
